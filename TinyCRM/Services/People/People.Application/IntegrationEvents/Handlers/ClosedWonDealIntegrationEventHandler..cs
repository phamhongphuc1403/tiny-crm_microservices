...
public class ClosedWonDealIntegrationEventHandler : IIntegrationEventHandler<ClosedWonDealIntegrationEvent>
{
    ...
    public ClosedWonDealIntegrationEventHandler(IAccountService accountService,
    ...
    public async Task Handle(ClosedWonDealIntegrationEvent @event)
    {
        ...
        account = _accountService.UpdateTotalSales(account, @event.ActualRevenue);
