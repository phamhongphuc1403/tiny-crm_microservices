...
public class EditDealLineCommandHandler : ICommandHandler<EditDealLineCommand, DealLineDto>
{
    ...
    public async Task<DealLineDto> Handle(EditDealLineCommand request, CancellationToken cancellationToken)
    {
