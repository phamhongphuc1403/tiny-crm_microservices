...
public class CloseAsLostDealCommandHandler : ICommandHandler<CloseAsLostDealCommand, DealDetailDto>
{
    ...
    public CloseAsLostDealCommandHandler(IDealDomainService dealDomainService,
    ...
    public async Task<DealDetailDto> Handle(CloseAsLostDealCommand request, CancellationToken cancellationToken)
    {
        ...
        deal = _dealDomainService.UpdateStatus(deal, DealStatus.Lost);
