...
namespace Sales.Infrastructure.EFCore.Migrations
{
    ...
    [Migration("20231013021135_AddActualRevenueDefaultValueInDealsTable")]
    partial class AddActualRevenueDefaultValueInDealsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sales.Domain.DealAggregate.Entities.Deal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sales.Domain.DealAggregate.Entities.DealLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sales.Domain.DealAggregate.Entities.Deal", b =>
                {
                    ...
                    b.HasOne("Sales.Domain.LeadAggregate.Lead", "Lead")
                        .WithOne("Deal")
                        .HasForeignKey("Sales.Domain.DealAggregate.Entities.Deal", "LeadId")
            ...
            modelBuilder.Entity("Sales.Domain.DealAggregate.Entities.DealLine", b =>
                {
                    b.HasOne("Sales.Domain.DealAggregate.Entities.Deal", "Deal")
                        .WithMany("DealLines")
